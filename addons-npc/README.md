...
- Java 25+;
- AurumCore 0.6.1+ — обязательная зависимость начиная с AddonsNPC 1.8.0;
...
Скопируйте `target/AddonsNPC-1.8.0.jar` в `plugins/` рядом с AurumCore 0.6.1+, перезапустите сервер и
