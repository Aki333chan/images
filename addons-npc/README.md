...
Произвольные консольные команды этим не покрываются: они могут менять данные любого
другого плагина. Для строгой однократности такая команда сама должна принимать стабильный
ключ операции либо предоставлять idempotent API.
