...
изменения инвентаря остаётся короткое at-least-once окно между действием Minecraft и
`advance`. До отдельного receipt/escrow нельзя обещать строгую однократность предметов
или произвольных консольных команд.
