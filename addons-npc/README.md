...
Незавершённые операции скупщиков и гильдейских торговцев записываются в
`plugins/AddonsNPC/transactions.yml`. Это служебный журнал: не редактируйте и не удаляйте
его во время работы сервера. Покупки в магазинах туда больше не попадают — их держит
AurumCore, см. ниже.
