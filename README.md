...
| --- | --- | --- |
| **Minecraft** (Java: Paper / Spigot / Vanilla) | Source RCON + опциональный companion-плагин | игроки, кик/бан, whitelist, быстрые команды, инвентарь и права (с плагином), тикеты из игры, автодополнение в консоли |
