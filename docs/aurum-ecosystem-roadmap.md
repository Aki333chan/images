...
1. [ ] Добавить в AddonsNPC компактный журнал item-saga и перевести магазины,
   скупщиков и гильдейских торговцев на holds API; сложная миграция тестовых NPC не требуется.
2. [ ] Перевести AurumSlots, AurumArena и AurumGuilds на native API по одному.
