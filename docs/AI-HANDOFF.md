...
**Экономические экраны AurumUI. Основное сделано, осталось две области.**

Вкладка «Экономика» готова: баланс по валютам и перевод у игрока, казна с денежной
массой и налогами, поиск игрока и give/take/set у администратора (AurumUI 0.6.0,
Companion 0.6.0, протокол 4). Не сделаны сделки и разбор карантина заявок из окна.
...
Дальше — AurumUI (клиентский мод): баланс, переводы, сделки, казна и админские формы.
Это приоритет владельца: повседневное администрирование экономики живёт в игре.
Панели остаются правила — налоги, комиссии, курсы — и разбор задним числом; мультивалютность
в панели отложена намеренно, одной валюты сейчас хватает. Разделение интерфейсов и
почему права раздаются узлами LuckPerms, а не OP, записаны в
`docs/aurum-core-architecture.md`, раздел «Кто чем управляет».
