 ...
 *
 * Раньше помощь была одной плотной строкой, где подкоманды шли через
 * вертикальную черту: «/auth reset|info|unlock|logout|history|…». Прочитать
 * это можно, а вот понять, что делает logout и чем он отличается от unlock, —
 * уже нет. Помощь для того и нужна, чтобы не приходилось спрашивать.
 *
...
public final class HelpBook {
     ...
     * набрал «/auth help 9», страниц две — показать вторую полезнее, чем
