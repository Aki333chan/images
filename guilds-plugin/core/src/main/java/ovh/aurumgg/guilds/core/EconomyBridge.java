...
public interface EconomyBridge {
    ...
    /**
     * Текущий авторитетный остаток счёта гильдии, если такой счёт ведёт мост.
     * Vault оставляет результат без числа: там источником остаётся сохранённое
     * поле Guilds. AurumCore возвращает ledger balance, чтобы прямой перевод
     * из панели не потерялся при роспуске.
     */
    default BankResult balance(long guildId) {
