 ...
 *
 * Их три — по числу возможностей, которые есть у игры на самом деле: игроки,
 * баны и белый список. Консоль даёт ядро. Инвентаря и тикетов здесь нет не
 * по недосмотру — их неоткуда взять, см. комментарий в sevendays.def.ts.
 */
