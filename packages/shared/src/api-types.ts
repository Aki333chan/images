...
export interface AppSettingsDto {
  ...
  /**
   * Предлагать ли на свежих серверах наши собственные плагины.
   *
   * Одним выключателем на всё сразу — и автоустановку companion, и поп-ап с
   * необязательными. Разделять их значило бы позвать человека в настройки
   * дважды: тот, кто выключает предложения, выключает их целиком.
   *
   * По умолчанию включено: панель без companion работает вполсилы, и молчать
   * об этом на сервере третьего лица — хуже, чем один раз предложить.
   */
