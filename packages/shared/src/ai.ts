...
Точный список доступных тебе действий и правила обращения с идентификаторами панель добавляет отдельным системным сообщением — оно всегда актуальнее этого текста.`;
