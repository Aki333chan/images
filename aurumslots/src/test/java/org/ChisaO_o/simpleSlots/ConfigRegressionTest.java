...
class ConfigRegressionTest {
    ...
    void addingMissingDefaultsDoesNotDisableVault() {
        ...
        assertEquals("en", existing.getString("language"));
    }
    ...
    void recognizesLegacySlotHologramsForCleanup() {
        ...
        assertTrue(SimpleSlots.isLegacyHologramText("§eBet: §a10$"));
        assertTrue(SimpleSlots.isLegacyHologramText("§eZakład: §a10$"));
    }
}
