...
provides cached PlaceholderAPI values, validates the financial policy model and
can initialize the versioned MariaDB schema.

## First installation

1. Keep EssentialsX and VaultUnlocked unchanged.
2. Copy `AurumCore-0.1.0.jar` to `plugins/`.
